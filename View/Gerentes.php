...
if ($resultados) {
    ...
    $_SESSION['nome'] = $resultados['nomeGerente'];
    $_SESSION['email'] = $resultados['emailGerente'];
    $_SESSION['senha'] = $resultados['senhaGerente'];
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="LogFuncionarios.php">Funcionário</a></li>
